...
private:
	...
	VkFence inFlightFence; //used to block host while gpu is rendering the previous frame
	...
	void createCommandBuffer(){
		...
		if(vkAllocateCommandBuffers(device, &allocInfo, &commandBuffer) != VK_SUCCESS) throw std::runtime_error("Could not allocate command buffers.\n");
	}
